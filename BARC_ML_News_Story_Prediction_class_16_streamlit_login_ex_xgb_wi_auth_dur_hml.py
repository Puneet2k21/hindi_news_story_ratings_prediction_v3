...
with open("voting_classifier_ex_xgb_dur_hml.pkl", "rb") as file:
    voting_classifier_ex_xgb_dur_hml = pickle.load(file)

# Load the preprocessor used during training (if applicable)
with open("preprocessor_dur_hml.pkl", "rb") as file:
    preprocessor_dur_hml = pickle.load(file)
...
if st.session_state['authentication_status']:
    ...
    if st.button("Predict Rating Tier"):
        new_data_transformed_show_case = preprocessor_dur_hml.transform(new_data_show_case)
        ...
        new_predictions_show_case = voting_classifier_ex_xgb_dur_hml.predict(new_data_transformed_dense_show_case)
